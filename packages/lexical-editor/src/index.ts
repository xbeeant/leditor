...
// 模板设计模式（design）与可填写字段
export type { EditorMode } from './context';
export { TemplateFieldExtension } from './plugins/template-field-extension';
export {
  INSERT_TEMPLATE_FIELD_COMMAND,
  SET_TEMPLATE_MODE_COMMAND,
} from './plugins/template-field-extension';
export type { TemplateFieldPayload } from './plugins/template-field-extension';
export type {
  SerializedTemplateFieldNode,
  TemplateFieldType,
