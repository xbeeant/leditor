...
export function SlashCommandPlugin({
  ...
  const callbacksRef = useRef({ onOpenEquation, onOpenImage });
  callbacksRef.current = { onOpenEquation, onOpenImage };
  ...
  const executeAction = useCallback(
    (action: SlashAction) => {
      const { onOpenEquation: oe, onOpenImage: oi } = callbacksRef.current;
      removeSlashText();
    ...
    [editor, removeSlashText, closeMenu],
  );
  ...
  }, [editor, isEditable, handleArrowDown, handleArrowUp, handleEnter, handleTab]);
