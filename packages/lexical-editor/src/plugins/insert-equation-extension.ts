import { INSERT_EQUATION_COMMAND, type InsertEquationPayload, insertBlockWithParagraphAfter } from '../commands';
import { EquationNode, $createEquationNode } from '../nodes';
import { $insertNodes, COMMAND_PRIORITY_EDITOR, defineExtension } from 'lexical';
