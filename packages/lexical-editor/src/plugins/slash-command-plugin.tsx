...
import { t } from '../i18n';
import { SLASH_ITEMS, type SlashAction, SlashMenu } from '../ui/slash-menu';
import { INSERT_CODE_DRAWING_COMMAND } from './code-drawing-extension';
import { INSERT_MERMAID_COMMAND } from './mermaid-extension';
...
export function SlashCommandPlugin({
  ...
  if (!menuOpen || filteredItems.length === 0) return null;
