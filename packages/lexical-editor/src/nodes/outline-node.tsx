...
/** 创建大纲节点 */
export function $createOutlineNode(data: OutlineData = DEFAULT_DATA): OutlineNode {
...
export class OutlineNode extends DecoratorNode<JSX.Element> {
  ...
  static override importJSON(serializedNode: SerializedOutlineNode): OutlineNode {
